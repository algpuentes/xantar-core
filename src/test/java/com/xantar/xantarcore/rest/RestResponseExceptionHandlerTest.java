...
public class RestResponseExceptionHandlerTest {
	 ...
	 * */
	@Test
	void handleConflict_shouldReturn_conflictCode() throws Exception {
	 ...
	 * */
	@Test
	void handleDataAccessError_shouldReturn_notFoundCode() throws Exception {
	 ...
	 * */
	@Test
	void handleIllegalArgumentError_shouldReturn_notFoundCode() throws Exception {
